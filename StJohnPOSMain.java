...
//The customer will order a random number of coffees, sodas, bagels,
//            etc.
//Keep in mind that we need to call rand.nextInt each time we want
//a new random number.
//If we just called rand.nextInt once, it means that the count of
//                    coffees, sodas, etc
